...
variable "vpc_name" {
  description = "Existing VPC name for resources that use private networking. Set in environments/*.tfvars."
  type        = string
  default     = null
}

variable "network_project_id" {
  description = "Optional project ID that owns the VPC network. Set in environments/*.tfvars when the VPC lives in a shared network project."
  type        = string
  default     = null
}
